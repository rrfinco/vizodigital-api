<x-filament-panels::page>
    <x-slot name="heading">
        White-label recharge commissions
    </x-slot>

    <x-slot name="description">
        Recharge providers ke liye commission % white-label-wise set karein.
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        @if (empty($this->whitelabelsForSelect()->all()))
            <div class="rounded-xl bg-amber-50 p-4 border border-amber-200 dark:bg-amber-950/20 dark:border-amber-900/50 text-sm text-amber-800 dark:text-amber-300">
                No white-labels found. Pehle White-labels module se partner create karein.
            </div>
        @endif
    </div>
</x-filament-panels::page>
